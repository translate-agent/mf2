...
func init() {
	...
	failing = []string{
		...
		// "TestMF2WG/.message-format-wg/test/tests/pattern-selection.json/.match_{0_:test:select}_{0_:test:select}_1_1_{{1,1}}_1_*_{{1,*}}_*_1_{{*,1}}_*_*_{{*,*}}",
		// "TestMF2WG/.message-format-wg/test/tests/pattern-selection.json/.match_{0_:test:select}_{1_:test:select}_1_1_{{1,1}}_1_*_{{1,*}}_*_1_{{*,1}}_*_*_{{*,*}}",
		// "TestMF2WG/.message-format-wg/test/tests/pattern-selection.json/.match_{0_:test:select}_1.0_{{1.0}}_1_{{1}}_*_{{other}}",
		...
		// "TestMF2WG/.message-format-wg/test/tests/pattern-selection.json/.match_{1_:test:select_fails=format}_1.0_{{1.0}}_1_{{1}}_*_{{other}}",
		// "TestMF2WG/.message-format-wg/test/tests/pattern-selection.json/.match_{1_:test:select}_{1_:test:select}_1_1_{{1,1}}_1_*_{{1,*}}_*_1_{{*,1}}_*_*_{{*,*}}",
		...
		"TestMF2WG/.message-format-wg/test/tests/pattern-selection.json/.input_{$x_:test:select}_.match_{$x}_1.0_{{1.0}}_1_{{1}}_*_{{other}}",
		// "TestMF2WG/.message-format-wg/test/tests/pattern-selection.json/.input_{$x_:test:select}_.match_{$x}_1.0_{{1.0}}_1_{{1}}_*_{{other}}#01",
		// "TestMF2WG/.message-format-wg/test/tests/pattern-selection.json/.input_{$x}_.match_{$x_:test:select}_1.0_{{1.0}}_1_{{1}}_*_{{other}}",
		// "TestMF2WG/.message-format-wg/test/tests/pattern-selection.json/.input_{$x}_.match_{$x_:test:select}_1.0_{{1.0}}_1_{{1}}_*_{{other}}#01",
		// "TestMF2WG/.message-format-wg/test/tests/pattern-selection.json/.input_{$x_:test:select}_.local_$y_=_{$x}_.match_{$y}_1.0_{{1.0}}_1_{{1}}_*_{{other}}#01",
		"TestMF2WG/.message-format-wg/test/tests/pattern-selection.json/.input_{$x_:test:select_decimalPlaces=1}_.local_$y_=_{$x_:test:select}_.match_{$y}_1.0_{{1.0}}_1_{{1}}_*_{{other}}",
		"TestMF2WG/.message-format-wg/test/tests/pattern-selection.json/.input_{$x_:test:select_decimalPlaces=9}_.match_{$x_:test:select_decimalPlaces=1}_1.0_{{1.0}}_1_{{1}}_*_{{bad-option-value}}",
	}
}
