...
func init() {
	...
	failing = []string{
		...
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_^_abc|123||5|\\\\_\\|def_|3.14||2|}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_!}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/.input{_$n_~_}{{{$n}}}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{$foo____>num_x_\\\\_abcde_|aaa||3.14|_|42|_r__}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{$foo____>num_x_\\\\_abcde_|aaa||3.14||42|_r__}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{$foo____+num_x_\\\\_abcde_|3.14|_r__}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|____+num_xx_\\\\_b_|3.14|_r__}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_%num_\\\\_b_|3.14|_r____}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_*num_\\\\_b_er}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_!xy_z_z_}",
		...
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/{>xyzz_}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{$x___<xyzz___}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{$foo_~xyzz_}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_>xyzz___}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_%xyzz_}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_?_}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_^_abc|123||5|\\\\}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_^abc|123||5|\\\\}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_*}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_%}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_%num\\\\\\}ber}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_%num\\{be\\|r}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_%num\\\\ber}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/{<tag}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{?number}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|foo|_*number}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|foo|_!number}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_?num|be||r|s}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_+num|be|r}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_^num|be|r}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_&num|be|r}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/{+42}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_%n|um|ber}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|4.2|_%number}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/.l_$y_=_{|bar|}_{{}}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/.i_{1}_{{}}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/.foo_|}lit{|_{42}{{bar}}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/.l_$x.y_=_{|bar|}_{{}}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/.foo_{42}_{{bar}}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/.foo{42}{{bar}}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/foo_{&private}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/foo_{+reserved}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/{!|a|}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/{!._\\{}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/foo_{?reserved_@a_@b=c}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/{^_.}",
		...
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/{!_.}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/{!.}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/.n.{a}{b}{{}}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/.n._{a}{{}}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/{!}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/{^}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/.n{a}{{}}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/.n_.{a}{{}}",
