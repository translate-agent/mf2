...
func init() {
	...
	failing = []string{
		...
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/.input_{$x_:x}_.match_$x_*_foo",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/.input_{$x_:x}_.match_$x_*_{{foo}}_extra",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/.input{_$n_~_}{{{$n}}}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/.local_$bar_=_{$none_~plural}_.match_{foo_:string}__*_{{{$bar}}}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/bad_{\\u0000placeholder}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/empty_{_}_placeholder",
		...
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/hello_{|foo|_*number}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/missing_space_{&private@bar}",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/no_{$placeholder_end",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/no_{placeholder_end",
		"TestMF2WG/.message-format-wg/test/tests/syntax-errors.json/no_{|placeholder|_end",
